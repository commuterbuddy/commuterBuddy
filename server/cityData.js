...
const cityData = {
  ...
  bakersfield: { lat: 35.3733, lng: -119.0187, gallon: 3.227 },
  ...
  stockton: { lat: 37.9577, lng: -121.2908, gallon: 3.256 },
  ...
  pasedena: { lat: 34.1478, lng: -118.1445, gallon: 3.400 },
  ...
  salinas: { lat: 36.6777, lng: -121.6555, gallon: 3.354 },
  ...
  modesto: { lat: 37.6391, lng: -120.9969, gallon: 3.205 },
  ventura: { lat: 34.2805, lng: -119.2945, gallon: 3.411 },
  anaheim: { lat: 33.8366, lng: -117.9143, gallon: 3.342 },
  pomona: { lat: 34.0551, lng: -117.7500, gallon: 3.400 },
  fresno: { lat: 36.7378, lng: -119.7871, gallon: 3.278 },
  ...
  chico: { lat: 39.7285, lng: -121.8375, gallon: 3.299 },
